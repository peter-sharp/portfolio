...
export function contactView(state, events) {
  return html`
  <section>
      <div class="portrait">
          <img class="responsive" src="{{pictureBasePath}}content/peter-like-a-sir.png"></img>
      </div>
      ...
      <p class="self-intro drop-cap">
          ...
          CPIT with majors in animation and illustration. </p>
      <p class="self-intro">
